...
public class Day13Test {
    ...
    public void pressesToWin_fromExamples() {
        assertThat(new Problem(94, 34, 22, 67, 8400, 5400).pressesToWin())
                .contains(new Solution(80, 40));

        assertThat(new Problem(26, 66, 67, 21, 12748, 12176).pressesToWin())
                .isEmpty();

        assertThat(new Problem(17, 86, 84, 37, 7870, 6450).pressesToWin())
                .contains(new Solution(38, 86));

        assertThat(new Problem(69, 23, 27, 71, 18641, 10279).pressesToWin())
                .isEmpty();
    }
